...
const deleteDebitos = async (req, reply) => {
  const sql = "DELETE FROM debito WHERE idUsuarios = $1 AND id_deb = $2"; // Usando $1 e $2 para parâmetros

  const values = [req.params.id, req.params.id_deb]; // Definindo os valores para a consulta
